...
public class ModelBombCart extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[1] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 1 wheel
		bodyModel[2] = new ModelRendererTurbo(this, 17, 1, textureX, textureY); // Box 2 wheel
		...
		bodyModel[3].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // Box 3
		...
		bodyModel[5].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // Box 5
