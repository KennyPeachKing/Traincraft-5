...
public class ModelAlcoS2 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[58] = new ModelRendererTurbo(this, 489, 9, textureX, textureY, "Lamp"); // Box 78 lamp
		...
		bodyModel[70] = new ModelRendererTurbo(this, 433, 25, textureX, textureY, "Lamp"); // Box 90 lamp
		...
		bodyModel[80] = new ModelRendererTurbo(this, 313, 41, textureX, textureY); // Box 101
		...
		bodyModel[149] = new ModelRendererTurbo(this, 385, 41, textureX, textureY, "Lamp"); // Box 78 lantern
		bodyModel[150] = new ModelRendererTurbo(this, 25, 49, textureX, textureY, "Lamp"); // Box 211 lamp
		...
		bodyModel[153] = new ModelRendererTurbo(this, 73, 49, textureX, textureY, "Lamp"); // Box 214 lamp
		bodyModel[154] = new ModelRendererTurbo(this, 497, 49, textureX, textureY, "Lamp"); // Box 160 lamp
		...
		bodyModel[157] = new ModelRendererTurbo(this, 161, 57, textureX, textureY, "Lamp"); // Box 163 lamp
		...
		bodyModel[176] = new ModelRendererTurbo(this, 281, 49, textureX, textureY); // Box 399
		...
		bodyModel[184] = new ModelRendererTurbo(this, 201, 73, textureX, textureY); // Box 221
		...
		bodyModel[197] = new ModelRendererTurbo(this, 233, 73, textureX, textureY, "Lamp"); // Box 234 glow
		bodyModel[198] = new ModelRendererTurbo(this, 281, 73, textureX, textureY, "Lamp"); // Box 235 glow
		...
		bodyModel[9].setRotationPoint(-29F, 5F, -12F);
		...
		bodyModel[26].setRotationPoint(-25F, -19F, -4F);
		...
		bodyModel[27].setRotationPoint(-25F, -19F, -7F);
		...
		bodyModel[28].setRotationPoint(-25F, -19F, 4F);
		...
		bodyModel[29].setRotationPoint(-25F, -20F, -4F);
		...
		bodyModel[30].setRotationPoint(-25F, -20F, -7F);

		bodyModel[31].addBox(0F, 0F, 0F, 37, 15, 14, 0F); // Box 41
		bodyModel[31].setRotationPoint(-24F, -19F, -7F);

		bodyModel[32].addBox(0F, 0F, 0F, 0, 2, 16, 0F); // Box 42
		bodyModel[32].setRotationPoint(29F, -4F, -8F);
		...
		bodyModel[35].setRotationPoint(-24F, -20F, -5F);
		...
		bodyModel[36].setRotationPoint(-24F, -20F, 5F);
		...
		bodyModel[37].setRotationPoint(-24F, -20F, -7F);

		bodyModel[38].addBox(0F, 0F, 0F, 11, 14, 1, 0F); // Box 48
		bodyModel[38].setRotationPoint(14F, -22F, -11F);

		bodyModel[39].addBox(0F, 0F, 0F, 11, 14, 1, 0F); // Box 49
		bodyModel[39].setRotationPoint(14F, -22F, 10F);
		...
		bodyModel[40].setRotationPoint(12F, -24F, 8F);
		...
		bodyModel[41].setRotationPoint(12F, -23F, 10F);
		...
		bodyModel[42].setRotationPoint(12F, -26F, 3F);

		bodyModel[43].addBox(0F, 0F, 0F, 13, 1, 6, 0F); // Box 135
		bodyModel[43].setRotationPoint(12F, -26F, -3F);
		...
		bodyModel[44].setRotationPoint(12F, -26F, -8F);
		...
		bodyModel[45].setRotationPoint(12F, -24F, -10F);
		...
		bodyModel[55].setRotationPoint(24F, -24.5F, -8F);
		...
		bodyModel[56].setRotationPoint(24F, -23F, -10F);
		...
		bodyModel[57].setRotationPoint(24F, -23F, 8F);

		bodyModel[58].addBox(0F, 0F, 0F, 1, 3, 3, 0F); // Box 78 lamp
		bodyModel[58].setRotationPoint(24.5F, -25F, -1.5F);
		...
		bodyModel[59].setRotationPoint(24.5F, -22F, -1.5F);

		bodyModel[60].addBox(0F, 0F, 0F, 0, 1, 20, 0F); // Box 80
		bodyModel[60].setRotationPoint(-29F, 3F, -10F);
		...
		bodyModel[62].setRotationPoint(-26F, 4F, 7F);
		...
		bodyModel[64].setRotationPoint(26F, 4F, 7F);

		bodyModel[65].addBox(0F, 0F, 0F, 0, 1, 4, 0F); // Box 85
		bodyModel[65].setRotationPoint(26F, 4F, -11F);
		...
		bodyModel[67].setRotationPoint(29F, 4F, -11F);

		bodyModel[68].addBox(0F, 0F, 0F, 0, 1, 20, 0F); // Box 88
		bodyModel[68].setRotationPoint(29F, 3F, -10F);

		bodyModel[69].addBox(0F, 0F, 0F, 0, 6, 3, 0F); // Box 89
		bodyModel[69].setRotationPoint(26F, -2F, 7F);

		bodyModel[70].addBox(0F, 0F, 0F, 1, 3, 3, 0F); // Box 90 lamp
		bodyModel[70].setRotationPoint(-25.5F, -18F, -1.5F);

		bodyModel[71].addBox(0F, 0F, 0F, 2, 2, 23, 0F); // Box 92
		bodyModel[71].setRotationPoint(-15.5F, -3F, -11.5F);

		bodyModel[72].addBox(0F, 0F, 0F, 2, 2, 23, 0F); // Box 93
		bodyModel[72].setRotationPoint(13.5F, -3F, -11.5F);

		bodyModel[73].addBox(0F, 0F, 0F, 10, 10, 1, 0F); // Box 94
		bodyModel[73].setRotationPoint(-22F, -16F, -7.5F);

		bodyModel[74].addBox(0F, 0F, 0F, 10, 10, 1, 0F); // Box 95
		bodyModel[74].setRotationPoint(-22F, -16F, 6.5F);
		...
		bodyModel[75].setRotationPoint(-25F, -20F, -5F);
		...
		bodyModel[76].setRotationPoint(-25F, -20F, 4F);
		...
		bodyModel[77].setRotationPoint(-25F, -20F, 4F);

		bodyModel[78].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 99
		bodyModel[78].setRotationPoint(3F, -21F, -4F);
		...
		bodyModel[79].setRotationPoint(3F, -22F, -4F);

		bodyModel[80].addBox(0F, 0F, 0F, 2, 3, 2, 0F); // Box 101
		bodyModel[80].setRotationPoint(4F, -25F, -3.5F);

		bodyModel[81].addBox(0F, 0F, 0F, 38, 8, 0, 0F); // Box 102
		bodyModel[81].setRotationPoint(-25F, -12F, -11F);
		...
		bodyModel[82].setRotationPoint(-27F, -12F, -11F);
		...
		bodyModel[83].setRotationPoint(10F, -13F, -11F);

		bodyModel[84].addBox(0F, 0F, 0F, 1, 7, 0, 0F); // Box 105
		bodyModel[84].setRotationPoint(11F, -20F, -11F);
		...
		bodyModel[85].setRotationPoint(11F, -22F, -11F);

		bodyModel[86].addBox(0F, 0F, 0F, 38, 8, 0, 0F); // Box 107
		bodyModel[86].setRotationPoint(-25F, -12F, 11F);

		bodyModel[87].addBox(0F, 0F, 0F, 1, 12, 0, 0F); // Box 108
		bodyModel[87].setRotationPoint(-27F, -10F, -11F);

		bodyModel[88].addBox(0F, 0F, 0F, 0, 1, 1, 0F); // Box 109
		bodyModel[88].setRotationPoint(-26F, 1F, -11F);

		bodyModel[89].addBox(0F, 0F, 0F, 0, 1, 1, 0F); // Box 110
		bodyModel[89].setRotationPoint(-26F, 1F, 10F);

		bodyModel[90].addBox(0F, 0F, 0F, 1, 12, 0, 0F); // Box 111
		bodyModel[90].setRotationPoint(-27F, -10F, 11F);
		...
		bodyModel[91].setRotationPoint(-27F, -12F, 11F);
		...
		bodyModel[92].setRotationPoint(-29F, 1F, -10F);

		bodyModel[93].addBox(0F, 0F, 0F, 0, 8, 1, 0F); // Box 114
		bodyModel[93].setRotationPoint(-29F, -7F, -10F);

		bodyModel[94].addBox(0F, 0F, 0F, 0, 1, 10, 0F); // Box 115
		bodyModel[94].setRotationPoint(-29F, -12F, -5F);
		...
		bodyModel[95].setRotationPoint(-29F, -12F, -10F);
		...
		bodyModel[96].setRotationPoint(-29F, -12F, 5F);

		bodyModel[97].addBox(0F, 0F, 0F, 0, 8, 1, 0F); // Box 118
		bodyModel[97].setRotationPoint(-29F, -7F, 9F);
		...
		bodyModel[98].setRotationPoint(-29F, 1F, 9F);
		...
		bodyModel[99].setRotationPoint(-29F, -6F, -5F);
		...
		bodyModel[100].setRotationPoint(-29F, -6F, 1F);

		bodyModel[101].addBox(0F, 0F, 0F, 0, 1, 1, 0F); // Box 122
		bodyModel[101].setRotationPoint(-29F, -11F, -5F);

		bodyModel[102].addBox(0F, 0F, 0F, 0, 1, 1, 0F); // Box 123
		bodyModel[102].setRotationPoint(-29F, -11F, 4F);

		bodyModel[103].addBox(0F, 0F, 0F, 0, 2, 2, 0F); // Box 124
		bodyModel[103].setRotationPoint(-29F, -6F, -1F);

		bodyModel[104].addBox(0F, 0F, 0F, 0, 2, 2, 0F); // Box 125
		bodyModel[104].setRotationPoint(29F, -6F, -1F);
		...
		bodyModel[105].setRotationPoint(29F, 1F, -10F);
		...
		bodyModel[107].setRotationPoint(29F, 1F, 9F);

		bodyModel[108].addBox(0F, 0F, 0F, 0, 8, 1, 0F); // Box 129
		bodyModel[108].setRotationPoint(29F, -7F, 9F);
		...
		bodyModel[109].setRotationPoint(29F, -12F, 5F);

		bodyModel[110].addBox(0F, 0F, 0F, 0, 1, 10, 0F); // Box 131
		bodyModel[110].setRotationPoint(29F, -12F, -5F);

		bodyModel[111].addBox(0F, 0F, 0F, 0, 1, 1, 0F); // Box 132
		bodyModel[111].setRotationPoint(29F, -11F, 4F);
		...
		bodyModel[112].setRotationPoint(29F, -6F, 1F);
		...
		bodyModel[113].setRotationPoint(29F, -12F, -10F);

		bodyModel[114].addBox(0F, 0F, 0F, 0, 1, 1, 0F); // Box 135
		bodyModel[114].setRotationPoint(29F, -11F, -5F);
		...
		bodyModel[115].setRotationPoint(29F, -6F, -5F);
		...
		bodyModel[117].setRotationPoint(-29F, 0.5F, -8F);
		...
		bodyModel[119].setRotationPoint(-21F, -21F, -4F);
		...
		bodyModel[120].setRotationPoint(-13F, -23F, -0.5F);
		...
		bodyModel[121].setRotationPoint(-13F, -24F, -0.5F);
		...
		bodyModel[122].setRotationPoint(-12.75F, -22.5F, -0.25F);
		...
		bodyModel[123].setRotationPoint(-13F, -21F, -2F);
		...
		bodyModel[124].setRotationPoint(-13F, -24F, -2F);
		...
		bodyModel[125].setRotationPoint(-13F, -24F, 1F);
		...
		bodyModel[126].setRotationPoint(-13F, -24.5F, -1F);

		bodyModel[127].addBox(0F, 0F, 0F, 1, 1, 2, 0F); // Box 117
		bodyModel[127].setRotationPoint(-13F, -20.5F, -1F);

		bodyModel[128].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 149 glow
		bodyModel[128].setRotationPoint(-22F, -18F, -7.5F);

		bodyModel[129].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 150 glow
		bodyModel[129].setRotationPoint(-22F, -18F, 6.5F);

		bodyModel[130].addBox(0F, 0F, 0F, 8, 5, 0, 0F); // Box 1
		bodyModel[130].setRotationPoint(15F, -20F, 12.5F);
		...
		bodyModel[131].setRotationPoint(15F, -15F, 10F);
		...
		bodyModel[132].setRotationPoint(15F, -20F, 10F);
		...
		bodyModel[133].setRotationPoint(15F, -21F, 10F);
		...
		bodyModel[134].setRotationPoint(23F, -20F, 10F);
		...
		bodyModel[135].setRotationPoint(24F, -24.5F, 3F);
		...
		bodyModel[136].setRotationPoint(24F, -24F, -8F);
		...
		bodyModel[137].setRotationPoint(24F, -24F, 3F);
		...
		bodyModel[138].setRotationPoint(13F, -24F, 3F);

		bodyModel[139].addBox(0F, 0F, 0F, 1, 1, 16, 0F); // Box 171
		bodyModel[139].setRotationPoint(13F, -23F, -8F);
		...
		bodyModel[140].setRotationPoint(13F, -23F, 8F);
		...
		bodyModel[141].setRotationPoint(13F, -24.5F, 3F);

		bodyModel[142].addBox(0F, 0F, 0F, 1, 2, 6, 0F); // Box 174
		bodyModel[142].setRotationPoint(13F, -25F, -3F);
		...
		bodyModel[143].setRotationPoint(13F, -24.5F, -8F);
		...
		bodyModel[144].setRotationPoint(13F, -24F, -8F);
		...
		bodyModel[145].setRotationPoint(13F, -23F, -10F);

		bodyModel[146].addBox(0F, 0F, 0F, 6, 9, 4, 0F); // Box 67
		bodyModel[146].setRotationPoint(12F, -16.98F, -1.5F);
		bodyModel[146].rotateAngleY = -0.48869219F;

		bodyModel[147].addBox(0F, 0F, 0F, 1, 4, 4, 0F); // Box 70
		bodyModel[147].setRotationPoint(14F, -18F, 3F);
		...
		bodyModel[148].setRotationPoint(14F, -25F, -1F);

		bodyModel[149].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 78 lantern
		bodyModel[149].setRotationPoint(19F, -25.5F, -1F);

		bodyModel[150].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, -0.5F, 0F, -0.5F, -0.5F); // Box 211 lamp
		bodyModel[150].setRotationPoint(-29.5F, -6F, 4.25F);
		...
		bodyModel[151].setRotationPoint(-29F, -6F, 4F);
		...
		bodyModel[152].setRotationPoint(-29F, -6F, -6F);

		bodyModel[153].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, -0.5F, 0F, -0.5F, -0.5F); // Box 214 lamp
		bodyModel[153].setRotationPoint(-29.5F, -6F, -5.75F);

		bodyModel[154].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -0.5F, -0.5F, -0.5F, -0.5F); // Box 160 lamp
		bodyModel[154].setRotationPoint(30F, -6F, -4.25F);
		...
		bodyModel[155].setRotationPoint(29.5F, -6F, -4F);
		...
		bodyModel[156].setRotationPoint(29.5F, -6F, 6F);
		bodyModel[156].rotateAngleY = -3.14159265F;

		bodyModel[157].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -0.5F, -0.5F, -0.5F, -0.5F); // Box 163 lamp
		bodyModel[157].setRotationPoint(30F, -6F, 5.75F);
		bodyModel[157].rotateAngleY = -3.14159265F;

		bodyModel[158].addBox(0F, 0F, 0F, 0, 8, 1, 0F); // Box 191
		bodyModel[158].setRotationPoint(26F, -7F, 10.5F);
		...
		bodyModel[159].setRotationPoint(26F, -12F, 6.5F);
		...
		bodyModel[160].setRotationPoint(26F, 1F, 10.5F);

		bodyModel[161].addBox(0F, 0F, 0F, 1, 1, 0, 0F); // Box 197
		bodyModel[161].setRotationPoint(25F, -12F, 6.5F);

		bodyModel[162].addBox(0F, 0F, 0F, 1, 1, 0, 0F); // Box 198
		bodyModel[162].setRotationPoint(25F, -12F, -6.5F);
		...
		bodyModel[163].setRotationPoint(26F, -12F, -11.5F);

		bodyModel[164].addBox(0F, 0F, 0F, 0, 8, 1, 0F); // Box 200
		bodyModel[164].setRotationPoint(26F, -7F, -11.5F);
		...
		bodyModel[165].setRotationPoint(26F, 1F, -11.5F);

		bodyModel[166].addBox(0F, 0F, 0F, 1, 9, 0, 0F); // Box 202
		bodyModel[166].setRotationPoint(24.5F, -21F, -2.5F);

		bodyModel[167].addBox(0F, 0F, 0F, 1, 9, 0, 0F); // Box 203
		bodyModel[167].setRotationPoint(24.5F, -21F, 2.5F);
		...
		bodyModel[168].setRotationPoint(10.5F, -25F, -0.5F);
		...
		bodyModel[169].setRotationPoint(11.5F, -25F, -0.5F);
		...
		bodyModel[170].setRotationPoint(12.5F, -25F, -0.5F);
		...
		bodyModel[171].setRotationPoint(10.5F, -27F, -0.5F);
		...
		bodyModel[172].setRotationPoint(11.5F, -27F, -0.5F);
		...
		bodyModel[173].setRotationPoint(12.5F, -27F, -0.5F);

		bodyModel[174].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 211
		bodyModel[174].setRotationPoint(-24F, -20.5F, -5.5F);

		bodyModel[175].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 212
		bodyModel[175].setRotationPoint(-24F, -20.5F, 4.5F);

		bodyModel[176].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 399
		bodyModel[176].setRotationPoint(13.32F, -27F, -0.5F);
		...
		bodyModel[177].setRotationPoint(13.5F, -27F, -0.5F);

		bodyModel[178].addBox(0F, 0F, 0F, 1, 2, 0, 0F); // Box 215
		bodyModel[178].setRotationPoint(20F, -26.5F, -6.5F);

		bodyModel[179].addBox(0F, 0F, 0F, 0, 5, 2, 0F); // Box 216
		bodyModel[179].setRotationPoint(14F, -20F, 10F);

		bodyModel[180].addBox(0F, 0F, 0F, 0, 5, 2, 0F); // Box 217
		bodyModel[180].setRotationPoint(14F, -20F, -12F);
		...
		bodyModel[181].setRotationPoint(16F, -22F, 11F);
		...
		bodyModel[182].setRotationPoint(16F, -22F, -12F);

		bodyModel[183].addBox(0F, 0F, 0F, 2, 7, 1, 0F); // Box 220 atsf stack
		bodyModel[183].setRotationPoint(4F, -27F, -3.5F);

		bodyModel[184].addBox(0F, 0F, 0F, 9, 2, 4, 0F); // Box 221
		bodyModel[184].setRotationPoint(-23F, -21.5F, -2F);

		bodyModel[185].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 222
		bodyModel[185].setRotationPoint(9F, -20.5F, -1F);
		...
		bodyModel[186].setRotationPoint(-32F, 4F, -4F);
		...
		bodyModel[187].setRotationPoint(-32F, 4F, 4F);
		...
		bodyModel[188].setRotationPoint(29F, 4F, 4F);
		...
		bodyModel[189].setRotationPoint(29F, 4F, -4F);

		bodyModel[190].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 227
		bodyModel[190].setRotationPoint(-29F, 5F, 10F);

		bodyModel[191].addBox(0F, 0F, 0F, 3, 2, 0, 0F); // Box 228
		bodyModel[191].setRotationPoint(-29F, 3F, 10F);

		bodyModel[192].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 229
		bodyModel[192].setRotationPoint(-29F, 3F, 8F);

		bodyModel[193].addBox(0F, 0F, 0F, 3, 3, 0, 0F); // Box 230
		bodyModel[193].setRotationPoint(-29F, 0.5F, 8F);

		bodyModel[194].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 231
		bodyModel[194].setRotationPoint(-29F, 0.5F, 7F);
		...
		bodyModel[197].addBox(0F, 0F, 0F, 1, 2, 4, 0F); // Box 234 glow
		bodyModel[197].setRotationPoint(-25F, -22F, 3F);
		bodyModel[197].rotateAngleY = -0.52359878F;

		bodyModel[198].addBox(0F, 0F, -4F, 1, 2, 4, 0F); // Box 235 glow
		bodyModel[198].setRotationPoint(-25F, -22F, -3F);
		bodyModel[198].rotateAngleY = 0.52359878F;

		bodyModel[199].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 236
		bodyModel[199].setRotationPoint(26F, 5F, 10F);

		bodyModel[200].addBox(0F, 0F, 0F, 3, 2, 0, 0F); // Box 237
		bodyModel[200].setRotationPoint(26F, 3F, 10F);

		bodyModel[201].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 238
		bodyModel[201].setRotationPoint(26F, 3F, 8F);

		bodyModel[202].addBox(0F, 0F, 0F, 3, 3, 0, 0F); // Box 239
		bodyModel[202].setRotationPoint(26F, 0.5F, 8F);

		bodyModel[203].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 240
		bodyModel[203].setRotationPoint(26F, 0.5F, 7F);
		...
		bodyModel[206].setRotationPoint(26F, 5F, -12F);

		bodyModel[207].addBox(0F, 0F, 0F, 3, 2, 0, 0F); // Box 244
		bodyModel[207].setRotationPoint(26F, 3F, -10F);
		...
		bodyModel[209].setRotationPoint(26F, 0.5F, -8F);

		bodyModel[210].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 247
		bodyModel[210].setRotationPoint(26F, 0.5F, -9F);
		...
		bodyModel[213].setRotationPoint(-29.01F, -5.5F, -7F);

		bodyModel[214].addBox(0F, 0F, 0F, 0, 2, 14, 0F); // Box 251
		bodyModel[214].setRotationPoint(29.01F, -5.5F, -7F);
		...
		bodyModel[215].setRotationPoint(-27F, -20F, -0.5F);
		...
		bodyModel[216].setRotationPoint(-27F, -21F, -0.5F);
		...
		bodyModel[217].setRotationPoint(-26.75F, -19.5F, -0.25F);
		...
		bodyModel[218].setRotationPoint(-27F, -21F, -1F);
		...
		bodyModel[219].setRotationPoint(-27F, -21F, 1F);
		...
		bodyModel[220].setRotationPoint(-26.75F, -21.25F, -1.5F);

		bodyModel[221].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 221
		bodyModel[221].setRotationPoint(-15.5F, -1F, -1F);

		bodyModel[222].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 222
		bodyModel[222].setRotationPoint(13.5F, -1F, -1F);
	}
