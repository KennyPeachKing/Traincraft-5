...
public class ModelHuskyStackWellcar extends ModelConverter
{
    ...
    private void initbodyModel_1()
    {
        ...
        bodyModel[11].setRotationPoint(-44.5F, -6F, -2F);
        ...
        bodyModel[12].setRotationPoint(36F, 2F, 9F);
        ...
        bodyModel[13].setRotationPoint(36F, 2F, -12F);
        ...
        bodyModel[15].setRotationPoint(-31F, 2F, -12F);
        ...
        bodyModel[16].setRotationPoint(-36F, 2F, 9F);
        ...
        bodyModel[17].setRotationPoint(-36F, 2F, -12F);
        ...
        bodyModel[18].setRotationPoint(31F, 2F, 9F);
        ...
        bodyModel[19].setRotationPoint(31F, 2F, -12F);

        bodyModel[20].addBox(0F, 0F, 0F, 9, 1, 16, 0F); // Box 114
        bodyModel[20].setRotationPoint(41F, 2F, -9F);

        bodyModel[21].addBox(0F, 0F, 0F, 7, 1, 22, 0F); // Box 115
        bodyModel[21].setRotationPoint(44F, 1F, -12F);

        bodyModel[22].addBox(0F, 0F, 0F, 3, 6, 4, 0F); // Box 116
        bodyModel[22].setRotationPoint(41F, -4F, -4F);
        ...
        bodyModel[23].setRotationPoint(42.5F, -4.5F, -2.5F);

        bodyModel[24].addBox(0F, 0F, 0F, 0, 4, 4, 0F); // Box 118
        bodyModel[24].setRotationPoint(44.5F, -6F, -4F);

        bodyModel[25].addBox(0F, 0F, 0F, 10, 4, 20, 0F); // Box 119
        bodyModel[25].setRotationPoint(31F, -1F, -11F);

        bodyModel[26].addBox(0F, 0F, 0F, 4, 1, 20, 0F); // Box 121
        bodyModel[26].setRotationPoint(32F, -3F, -11F);

        bodyModel[27].addBox(0F, 0F, 0F, 3, 1, 9, 0F); // Box 122
        bodyModel[27].setRotationPoint(41F, 0F, 1F);

        bodyModel[28].addBox(0F, 0F, 0F, 62, 1, 20, 0F); // Box 101
        bodyModel[28].setRotationPoint(-31F, 7F, -11F);
        ...
        bodyModel[29].setRotationPoint(-32F, 2F, -11F);
    ...
    public ModelRendererTurbo ModelHuskyStackWellcar[];
}