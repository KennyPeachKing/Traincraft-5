...
public class MTCMultiTransmitter {

    public static class mtBlock extends BlockContainer {
        public mtBlock(Material p_i45386_1_) {
            super(p_i45386_1_);
        }
    ...
    public static class mtTile extends TileEntity implements SimpleComponent {
