...
public enum EnumSounds {
	...
	locoHeavySteam(EntityLocoSteamHeavy.class, "heavy_whistle", 1F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
	...
	locoSteamberk1225(EntityLocoSteamBerk1225.class, "pe_whistle", 0.6F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
	...
	locoSteamAdler(EntityLocoSteamAdler.class, "adler_whistle", 0.8F, "adler_run", 0.2F, 20, "adler_run", 0.2F, 20,
			true),
	GS4(EntityLocoSteamGS4.class, "daylight_whistle", 0.8F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
	...
	locoClimax(EntityLocoSteamClimax.class, "crosby_3chime", 0.6F, "steam_run", 0.2F, 20, "steam_run", 0.2F, 20, true),
	...
	locoBP4(EntityLocoElectricBP4.class, "nathan_k5La_3", 0.8F, "mg_run", 0.6F, 8, "mg_idle", 0.4F, 50, false),
	...
	driverlessMetro(com.jcirmodelsquad.tcjcir.locomotives.DriverlessMetro.class, "nathan_p2", 1F, "mg_run", 0.6F, 8, "mg_idle", 0.4F, 50, false),
	...
	H1044(com.jcirmodelsquad.tcjcir.locomotives.DieselH1044.class, "wabco_e2", 10F, "h10_notch8", 0.65F, 40, "h10_idle", 0.65F, 40, false),
	Thanos(com.jcirmodelsquad.tcjcir.locomotives.Thanos.class, "thanos_horn", 5, "thanos_run", 0.65F, 60, "thanos_idle", 0.65F, 60, false),
	HighrailTruck(com.jcirmodelsquad.tcjcir.locomotives.DieselHighrailTruck.class, "truck_horn", 0.8F, "boxcab_notch8", 0.65F, 15, "boxcab_idle", 0.65F, 25, true),
	...
	SD45dash2(com.jcirmodelsquad.tcjcir.locomotives.DieselSD45dash2.class, "leslie_rs5t", 2.5F, "645e3_notch8", 0.65F, 10, "645e3_idle", 0.65F, 3, true),
	SD40dash2(com.jcirmodelsquad.tcjcir.locomotives.DieselSD40dash2.class, "leslie_rs3k", 2.5F, "16-645e_notch8", 0.65F, 10, "16-645e_idle", 0.8F, 5, true),
	...
	testControlCar(com.jcirmodelsquad.tcjcir.rollingstock.TestControlCar.class, "nathan_p2", 1F, "mg_run", 0.6F, 8, "mg_idle", 0.4F, 50, false),
	PCH100H(com.jcirmodelsquad.tcjcir.locomotives.PCH100H.class, "nathan_p2", 1F, "pch100h_notch8", 0.6F, 8, "pch100h_idle", 0.4F, 50, false),
