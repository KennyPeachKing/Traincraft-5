...
public enum EnumSounds {
	...
	locoSteamberk1225(EntityLocoSteamBerk1225.class, "1225_whistle", 0.6F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
	locoSteamAlcoSC4(EntityLocoSteamAlcoSC4.class, "southern_3chime", 0.6F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
	...
	locoSteamC41T(EntityLocoSteamC41T.class, "drgw_5chime", 0.6F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
	...
	locoClimax(EntityLocoSteamClimax.class, "crosby_3chime", 0.8F, "steam_run", 0.2F, 20, "steam_run", 0.2F, 20, true),
	...
	driverlessMetro(com.jcirmodelsquad.tcjcir.locomotives.DriverlessMetro.class, "leslie_rs3k", 1F, "mg_run", 0.6F, 8, "mg_idle", 0.4F, 50, false),
	...
	Thanos(com.jcirmodelsquad.tcjcir.locomotives.Thanos.class, "thanos_horn", 5, "thanos_run", 0.6F, 10, "thanos_idle", 0.65F, 10, false),
