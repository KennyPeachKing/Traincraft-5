...
public enum EnumTrains {
	...
	passengerHighSpeedZeroED("Passenger High Speed Zero ED", EntityPassengerHighSpeedCarZeroED.class, ItemIDs.minecartPassengerHighSpeedCarZeroED.item, "passenger", 0, 0, 2, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"White", "LightGrey"}), 18, 0),
	...
	tankWagonUS("Tank Wagon US", EntityTankWagonUS.class, ItemIDs.minecartTankWagonUS.item, "tank", 0, 0, 6, 0, 0, 0, 0, 0, 70000, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Grey", "Yellow", "White", "LightGrey", "Green"}), 18, 0, "Capacity: 70000mb"),
	...
	locoElectricSpeedZeroED("Loco Electric High Speed ZeroED", EntityLocoElectricHighSpeedZeroED.class, ItemIDs.minecartLocoHighSpeedZeroED.item, "electric", 700, 237, 0, 3, 0,230, 1.4, 0.98, 0, TraincraftUtil.getBytesFromColors(new String[] {"White","LightGrey"}), 13,  -3.4),
	...
	//JCIR-TC
	locoAlcoS2("Alco S2",  com.jcirmodelsquad.tcjcir.locomotives.DieselAlcoS2.class, ItemIDs.minecartAlcoS2.item, "diesel", 1000, 96, 0, 45, 0, 170, 0.7, 0.965, 8000,TraincraftUtil.getBytesFromColors(new String[] {"Black", "Grey", "Green", "Orange", "Pink", "White", "Blue"}), 18, -2, "Created by Bidahochi"),
	driverlessMetro("PCH-120 Commute", com.jcirmodelsquad.tcjcir.locomotives.DriverlessMetro.class, ItemIDs.minecartDriverlessMetro.item, "electric",1400, 120, 0, 5, 0, 160, 0.8, 0.985, 0, TraincraftUtil.getBytesFromColors(new String[] {"White", "Blue"}), 18, -2.7, "Model by Bidahochi, train by PeachMaster"),
	...
	SW1("SW1", com.jcirmodelsquad.tcjcir.locomotives.DieselSW1.class, ItemIDs.minecartSW1.item, "diesel", 600, 105, 0, 45, 0, 160, 0.6, 0.890, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Green", "Blue", "Black", "Pink"}), 18, -2.1, "model by Bida as usual kEk"),
	...
	HighrailTruck("HighrailTruck", com.jcirmodelsquad.tcjcir.locomotives.DieselHighrailTruck.class, ItemIDs.minecartHighrailTruck.item, "diesel", 90, 80, 0, 10, 0, 140, 0.7, 0.8, 1000,TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "White"}),18, 2.7, "Model by MessibOOmer"),
	...
	U23B("U23B", com.jcirmodelsquad.tcjcir.locomotives.DieselU23B.class, ItemIDs.minecartU23B.item, "diesel", 2250, 70, 0, 55, 0, 180, 0.7, 0.91, 18000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Orange", "LightGrey", "Pink", "Lime", "Blue", "LightBlue", "Black", "Green"}), 10, -3.7, "Made by Bida"),
	...
	SD45dash2("SD45dash2", com.jcirmodelsquad.tcjcir.locomotives.DieselSD45dash2.class, ItemIDs.minecartSD45dash2.item, "diesel", 3600, 132, 0, 65, 0, 190, 0.75, 0.89, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "White", "Black", "Orange", "Blue", "Pink", "Magenta"}), 10, -4.6, "Model by Bida"),
	SD40dash2("SD40dash2", com.jcirmodelsquad.tcjcir.locomotives.DieselSD40dash2.class, ItemIDs.minecartSD40dash2.item, "diesel", 3000, 105, 0, 60, 0, 190, 0.75, 0.89, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Green", "Pink", "Magenta", "White", "Yellow"}), 10, -4.6, "Model by the great and powerful Bida"),
	...
	CF7("CF7", com.jcirmodelsquad.tcjcir.locomotives.DieselCF7.class, ItemIDs.minecartCF7.item, "diesel", 1500, 116, 0, 45, 0, 185, 0.8, 0.9, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Red", "LightGrey", "White", "Cyan", "Lime", "Magenta", "Purple"}), 10, -3, "Model version: 4.5 By Bida"),
	SD9("SD9", com.jcirmodelsquad.tcjcir.locomotives.DieselSD9.class, ItemIDs.minecartSD9.item, "diesel", 1750, 104, 0, 50, 0, 190, 0.75, 0.89, 19000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Green", "Cyan", "Orange", "Grey", "White"}), 10, -3.1, "Bida made this, surprising isnt it?"),
	WoodchipHopper("WoodchipHopper", com.jcirmodelsquad.tcjcir.rollingstock.WoodchipHopper.class, ItemIDs.minecartWoodchipHopper.item, "freight", 5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Blue", "Green", "Orange", "Red"}), 0, 50, "Cargo: Wood, Model by Binky"),
	OreJenny("OreJenny", com.jcirmodelsquad.tcjcir.rollingstock.OreJenny.class, ItemIDs.minecartOreJenny.item, "freight", 0.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Red", "Orange", "Pink"}), 0, 27, "Cargo: Ore (dUh), Model by Binky"),
	...
	geGenesis("Ge Genesis", com.jcirmodelsquad.tcjcir.locomotives.GeGenesis.class, ItemIDs.minecartGeGenesis.item, "diesel", 4250, 177, 0, 55, 0, 175, 0.93, 0.94, 20000, TraincraftUtil.getBytesFromColors(new String[] {"" + "LightGrey", "Grey", "White"}), 10, -5.5, "Model by MessicOOmer"),
	ES44("ES44", com.jcirmodelsquad.tcjcir.locomotives.DieselES44.class, ItemIDs.minecartES44.item, "diesel", 4400, 120, 0, 60, 0, 190, 0.7, 0.8, 25000, TraincraftUtil.getBytesFromColors(new String[] {"Lime", "Orange"}), 10, -4.3, "Model by Eddie Dalton, upgraded by Bida"),;
