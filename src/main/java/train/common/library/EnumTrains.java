...
public enum EnumTrains {
	...
	geGenesis("Ge Genesis", com.jcirmodelsquad.tcjcir.locomotives.GeGenesis.class, ItemIDs.minecartGeGenesis.item, "diesel", 4250, 117, 0, 55, 0, 175, 0.93, 0.94, 20000, TraincraftUtil.getBytesFromColors(new String[] {"" + "LightGrey", "Grey", "White"}), 10, -5.5, "Model by MessicOOmer"),
