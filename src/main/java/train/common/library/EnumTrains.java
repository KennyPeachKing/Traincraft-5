...
public enum EnumTrains {
	...
	SD9("SD9", com.jcirmodelsquad.tcjcir.locomotives.DieselSD9.class, ItemIDs.minecartSD9.item, "diesel", 1750, 104, 0, 50, 0, 190, 0.75, 0.89, 19000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Green", "Cyan", "Orange", "Grey"}), 10, -3.1, "Bida made this, surprising isnt it?"),
