...
public enum EnumTrains {
	...
	//JCIR-TC
	locoAlcoS2("Alco S2",  com.jcirmodelsquad.tcjcir.locomotives.DieselAlcoS2.class, ItemIDs.minecartAlcoS2.item, "diesel", 1000, 96, 0, 10, 0, 170, 0.7, 0.965, 15000,TraincraftUtil.getBytesFromColors(new String[] {"Black", "Grey", "Green", "Orange", "Pink", "White"}), 18, -2, "Created by Bidahochi"),
	...
	H1044("H1044", com.jcirmodelsquad.tcjcir.locomotives.DieselH1044.class, ItemIDs.minecartH1044.item, "diesel", 1000, 97, 0, 10, 0, 175, 0.75, 0.92, 14000, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Yellow", "Black", "Red", "Blue", "Grey", "LightBlue", "Orange", "White", "Lime"}), 18, -2.2, "Model by Bida"),
	...
	SD45dash2("SD45dash2", com.jcirmodelsquad.tcjcir.locomotives.DieselSD45dash2.class, ItemIDs.minecartSD45dash2.item, "diesel", 3600, 132, 0, 10, 0, 190, 0.75, 0.89, 1500, TraincraftUtil.getBytesFromColors(new String[] {"Green", "White", "Black", "Orange", "Blue", "Pink", "Magenta"}), 10, -5.4, "Model by Bida"),
	SD40dash2("SD40dash2", com.jcirmodelsquad.tcjcir.locomotives.DieselSD40dash2.class, ItemIDs.minecartSD40dash2.item, "diesel", 3000, 105, 0, 9, 0, 190, 0.75, 0.89, 1500, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Green", "Pink", "Magenta", "White"}), 10, -5.4, "Model by the great and powerful Bida"),;
