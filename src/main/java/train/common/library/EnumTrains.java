...
public enum EnumTrains {
	...
	F7A("F7A", com.jcirmodelsquad.tcjcir.locomotives.DieselF7A.class, ItemIDs.minecartF7A.item, "diesel", 1500, 133, 0, 50, 0, 180, 0.7, 0.79, 20000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Black", "Orange", "Yellow", "Red"}), 10, -3, "Model by Binky and Bida"),
	F7B("F7B", com.jcirmodelsquad.tcjcir.locomotives.DieselF7B.class, ItemIDs.minecartF7B.item, "diesel", 1500, 133, 0, 50, 0, 180, 0.7, 0.79, 20000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Black", "Orange", "Red"}), 10, -3, "Model by Binky and Bida. Its a B unit, but it can move on its own!"),
