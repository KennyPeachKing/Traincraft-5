...
public enum EnumTrains {
	...
	C424("C424", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DieselC424.class, ItemIDs.minecartC424.item, "diesel", 2400, 113, 0, 60, 0, 190, 0.7, 0.8, 19000, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Black"}), 10, -3.6, "Yet Another Bida Model kek"),;
