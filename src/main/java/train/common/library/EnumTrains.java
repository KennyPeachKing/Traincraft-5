...
public enum EnumTrains {
	...
	ES44("ES44", com.jcirmodelsquad.tcjcir.locomotives.DieselES44.class, ItemIDs.minecartES44.item, "diesel", 4400, 120, 0, 60, 0, 190, 0.7, 0.8, 25000, TraincraftUtil.getBytesFromColors(new String[] {"Lime", "Orange", "Red", "Yellow", "Blue"}), 10, -4.3, "Model by Eddie Dalton, upgraded by Bida"),;
