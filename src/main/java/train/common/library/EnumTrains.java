...
public enum EnumTrains {
	...
	F7B("F7B", com.jcirmodelsquad.tcjcir.locomotives.DieselF7B.class, ItemIDs.minecartF7B.item, "diesel", 1500, 133, 0, 50, 0, 180, 0.7, 0.79, 20000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Black", "Orange", "Grey", "Red", "Yellow", "LightGrey"}), 10, -3, "Model by Binky and Bida. Its a B unit, but it can move on its own!"),
