...
public enum EnumTrains {
	...
	driverlessMetro("PCH-120 Commute", com.jcirmodelsquad.tcjcir.vehicles.locomotives.DriverlessMetro.class, ItemIDs.minecartDriverlessMetro.item, "electric",1400, 120, 0, 5, 0, 160, 0.8, 0.985, 0, TraincraftUtil.getBytesFromColors(new String[] {"White", "Blue", "Red"}), 18, -2.7, "Model by Bidahochi, train by PeachMaster"),
	driverlessMetroCar("PCH-120 Commute Car", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.PCH120Car.class, ItemIDs.minecartDriverlessMetroCar.item, "passenger",0, 0, 2, 0, 0, 0, 0, 0, 0,TraincraftUtil.getBytesFromColors(new String[] {"White", "Blue", "Red"}), 0, 0,"Model by Bidahochi"),
	...
	PCH100H("PCH-100H", com.jcirmodelsquad.tcjcir.vehicles.locomotives.PCH100H.class, ItemIDs.minecartExperimentalHydrogenTrain.item, "hydrogen",900, 100, 0, 6, 0, 160, 0.8, 0.985, 7000, null, 18,  -2.6, "Powered by Mekanism Hydrogen, Original model by Bidahochi, modified by PeachMaster"),
	PCH100Coach("PCH-100H Coach", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.PCH100HCoach.class, ItemIDs.minecartPCH100HCoach.item, "passenger",0, 0, 2, 0, 0, 0, 0, 0, 0,null, 0, 0,"Original model by Bidahochi, modified by PeachMaster"),
