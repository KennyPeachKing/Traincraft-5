...
public enum EnumTrains {
	...
	SD45dash2("SD45-2", com.jcirmodelsquad.tcjcir.locomotives.DieselSD45dash2.class, ItemIDs.minecartSD45dash2.item, "diesel", 3600, 132, 0, 65, 0, 190, 0.75, 0.89, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "White", "Black", "Orange", "Blue", "Pink", "Magenta", "LightBlue"}), 10, -4.6, "Model by Bida"),
	SD40dash2("SD40-2", com.jcirmodelsquad.tcjcir.locomotives.DieselSD40dash2.class, ItemIDs.minecartSD40dash2.item, "diesel", 3000, 105, 0, 60, 0, 190, 0.75, 0.89, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Green", "Pink", "Magenta", "White", "Yellow", "Black", "Blue", "LightGrey", "Red", "Lime"}), 10, -4.6, "Model by the great and powerful Bida"),
