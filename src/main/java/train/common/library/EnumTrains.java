...
public enum EnumTrains {
	...
	WoodchipHopper("Woodchip Hopper", com.jcirmodelsquad.tcjcir.rollingstock.WoodchipHopper.class, ItemIDs.minecartWoodchipHopper.item, "freight", 5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Blue", "Green", "Orange", "Red", "White"}), 0, 50, "Cargo: Wood, Model by Binky"),
	...
	SDL39("SDL39", com.jcirmodelsquad.tcjcir.locomotives.DieselSDL39.class, ItemIDs.minecartSDL39.item, "diesel", 2300, 152, 0, 60, 0, 180, 0.8, 0.9, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Blue", "Red"}), 10, -3, "model by binky"),
	...
	F7B("F7B", com.jcirmodelsquad.tcjcir.locomotives.DieselF7B.class, ItemIDs.minecartF7B.item, "diesel", 1500, 133, 0, 50, 0, 180, 0.7, 0.79, 20000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Black", "Orange", "Grey", "Red", "Yellow"}), 10, -3, "Model by Binky and Bida. Its a B unit, but it can move on its own!"),
